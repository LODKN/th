#    جميع الحقوق لمطوري سورس ماتركـس حصريا لهم فقط
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("♰ قناتنا ♰", "https://t.me/k4kk44")],
                [Button.url("♰ المساعده ♰", "https://t.me/nnuuun")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer(
            "انت لا تستطيع استخدام البوت احصل على بوتك من @DEOOUS", alert=True
        )
...
async def settings(event):  #    قـسـم  الزغرفـة جمـثـون
    if event.sender_id == bot.uid:
        ...
        await event.answer(
            "انت لا تستطيع استخدام البوت احصل على بوتك من @k4kk44", alert=True
        )
...
async def settings(event):  #    قـسـم  الزغرفـة لأسـماء الشـباب 1
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(
            event.chat_id, Boyroz1, buttons=[[Button.inline("║ رجوع ║", data="razan")]]
        )
    else:
...
async def settings(event):  #    قـسـم  الزغرفـة لأسـماء الشـباب 2
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(
            event.chat_id, Boyroz2, buttons=[[Button.inline("║ رجوع ║", data="razan")]]
        )
    else:
        await event.answer("انت لا تستطيع استخدام هذا البوت.", alert=True)
...
async def settings(event):  #    قـسـم  الزغرفـة لأسـماء البـنات 1
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(
            event.chat_id, Girlan1, buttons=[[Button.inline("║ رجوع ║", data="RR7PP")]]
        )
    else:
        await event.answer("انت لا تستطيع استخدام هذا البوت.", alert=True)
...
async def settings(event):  #    قـسـم  الزغرفـة لأسـماء البـنات 2
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(
            event.chat_id, Girlan2, buttons=[[Button.inline("║ رجوع ║", data="RR7PP")]]
        )
    else:
        await event.answer("انت لا تستطيع استخدام هذا البوت.", alert=True)
...
async def settings(event):  #    قـسم الـمواليـد و الأشـهر
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            buttons=[
                [
                    Button.inline("المواليد َِ🛹 ", data="rozyear"),
                    Button.inline("الاشهر َِ🛹", data="months"),
                ],
                [Button.inline("║ رجوع ║", data="rozzag")],
            ],
        )
...
async def settings(event):  #    قـسم  الأشـهر
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(
            event.chat_id, JMTHSH, buttons=[[Button.inline("║ رجوع ║", data="rozzag")]]
        )
    else:
        await event.answer("انت لا تستطيع استخدام هذا البوت.", alert=True)
...
async def settings(event):  # انتهـى  :)  اذا تخـمط تـذكر تعـب غـيرك  :)
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(
            event.chat_id, CHANLAN, buttons=[[Button.inline("║ رجوع ║", data="rozzag")]]
        )
    else:
        await event.answer("انت لا تستطيع استخدام هذا البوت.", alert=True)
